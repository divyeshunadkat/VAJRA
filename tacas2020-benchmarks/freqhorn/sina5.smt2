...
(declare-rel inv5 ((Array Int Int) (Array Int Int) Int Int Int))
(declare-rel fail ())
...
(rule (=> (and (inv4 a b i n sum) (< i n) (= sum1 (+ sum (select b i))) (= i1 (+ i 1))) (inv4 a b i1 n sum1)))

(rule (=> (and (inv4 a b i n sum) (>= i n)) (inv5 a b 0 n sum)))

(rule (=> (and (inv5 a b i n sum) (< i n) (= a1 (store a i (+ (select a i) sum))) (= i1 (+ i 1))) (inv5 a1 b i1 n sum)))

(rule (=> (and (inv5 a b i n sum) (>= i n) (< 0 i1) (< i1 n) (not (= (select a i1) (+ (* 2 n) 1)))) fail))
