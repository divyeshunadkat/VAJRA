...
;
(set-logic HORN)
(declare-fun assert_40_1_232 (Int (Array Int Int) Int Int ) Bool)
...
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_34_1_207 sum  a  N  i ) (not (< i  N ))) (assert_40_1_232 sum  a  N  i ))))
;
;(assign)  sum := (sum+a[i])
...
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_40_1_232 sum  a  N  i ) (or (<= N  0) (= sum  (* N  (+ N  1)))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_40_1_232 sum  a  N  i ) (end sum  a  N  i ))))
(check-sat)
