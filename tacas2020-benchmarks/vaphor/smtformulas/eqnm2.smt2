...
;
;(aassign) a[0] := 4
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (arrayassign_9_1_49 b  a  N  i ) (arrayassign_10_1_59 b  (store a  0 4) N  i ))))
;
;(aassign) b[0] := 1
...
;
;(aassign) a[i] := (a[(i-1)]+4)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (arrayassign_15_2_93 b  a  N  i ) (assign_16_2_102 b  (store a  i  (+ (select a  (- i  1)) 4)) N  i ))))
;
;(assign)  i := (i+1)
...
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) ) ( => (assert_29_2_201 b  a  N  i ) (= (select b  i ) (+ (+ (* (* 2 i ) i ) (* 2 i )) 1)))))
