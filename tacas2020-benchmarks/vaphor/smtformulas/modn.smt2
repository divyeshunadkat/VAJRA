...
(declare-fun assign_25_1_124 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_22_2_115 (Int (Array Int Int) Int Int ) Bool)
(declare-fun arrayassign_21_2_106 (Int (Array Int Int) Int Int ) Bool)
(declare-fun while_19_8_118 (Int (Array Int Int) Int Int ) Bool)
...
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_18_1_85 sum  a  N  i ) (while_19_8_118 sum  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_19_8_118 sum  a  N  i ) (< i  N )) (arrayassign_21_2_106 sum  a  N  i ))))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_19_8_118 sum  a  N  i ) (not (< i  N ))) (assign_25_1_124 sum  a  N  i ))))
;
;(aassign) a[i] := (sum%N)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (arrayassign_21_2_106 sum  a  N  i ) (assign_22_2_115 sum  (store a  i  (mod sum  N )) N  i ))))
;
;(assign)  i := (i+1)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_22_2_115 sum  a  N  i ) (while_19_8_118 sum  a  N  (+ i  1)))))
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_25_1_124 sum  a  N  i ) (while_26_8_158 sum  a  N  0))))
;
;(while)   while((i<N))
...
;
;(assert)  (a[i]==0)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_28_2_146 sum  a  N  i ) (= (select a  i ) 0))))
