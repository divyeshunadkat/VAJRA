...
;
(set-logic HORN)
(declare-rel assert_39_1_226 (Int Int Int Int Int Int))
(declare-rel assign_36_2_198 (Int Int Int Int Int Int))
(declare-rel assign_35_2_189 (Int Int Int Int Int Int))
(declare-rel while_33_1_201 (Int Int Int Int Int Int))
...
;
;(assign)  i := 0
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assign_32_1_168 sum a_size a1_ind a1_val N i)) (while_33_1_201 sum a_size a1_ind a1_val N 0))))
;
;(while)   while((i<N))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_33_1_201 sum a_size a1_ind a1_val N i) (< i N)) (assign_35_2_189 sum a_size a1_ind a1_val N i))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_33_1_201 sum a_size a1_ind a1_val N i) (not (< i N))) (assert_39_1_226 sum a_size a1_ind a1_val N i))))
;
;(assign)  sum := (sum+a[i])
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int) (tmp_select_a Int)) (=> (and (<= 0 a_size) (assign_35_2_189 sum a_size a1_ind a1_val N i) (or (and (= a1_ind i) (= tmp_select_a a1_val)) (and (< i a1_ind) (<= 0 a_size) (assign_35_2_189 sum a_size i tmp_select_a N i)) (and (< a1_ind i) (<= 0 a_size) (assign_35_2_189 sum a_size i tmp_select_a N i)))) (assign_36_2_198 (+ sum tmp_select_a) a_size a1_ind a1_val N i))))
;
;(assign)  i := (i+1)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assign_36_2_198 sum a_size a1_ind a1_val N i)) (while_33_1_201 sum a_size a1_ind a1_val N (+ i 1)))))
;
;(assert)  ((N<=0)||(sum==(N*(N+2))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_39_1_226 sum a_size a1_ind a1_val N i)) (or (<= N 0) (= sum (* N (+ N 2)))))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_39_1_226 sum a_size a1_ind a1_val N i)) (end sum a_size a1_ind a1_val N i))))
(check-sat)
