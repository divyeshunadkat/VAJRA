...
;
(set-logic HORN)
(declare-fun assign_38_2_272 ((Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
(declare-fun assert_37_2_263 ((Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
(declare-fun while_35_1_275 ((Array Int Int) (Array Int Int) (Array Int Int) Int Int ) Bool)
...
;
;(aassign) c[0] := N
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (c (Array Int Int)) ) ( => (arrayassign_11_1_74 c  b  a  N  i ) (assign_13_1_80 (store c  0 N ) b  a  N  i ))))
;
;(assign)  i := 1
...
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (c (Array Int Int)) ) ( => (assign_34_1_232 c  b  a  N  i ) (while_35_1_275 c  b  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((c (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_35_1_275 c  b  a  N  i ) (< i  N )) (assert_37_2_263 c  b  a  N  i ))))
(assert (forall ((c (Array Int Int)) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_35_1_275 c  b  a  N  i ) (not (< i  N ))) (end c  b  a  N  i ))))
;
;(assert)  (c[i]==(N+((i*i)*i)))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (c (Array Int Int)) ) ( => (assert_37_2_263 c  b  a  N  i ) (= (select c  i ) (+ N  (* (* i  i ) i ))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (c (Array Int Int)) ) ( => (assert_37_2_263 c  b  a  N  i ) (assign_38_2_272 c  b  a  N  i ))))
;
;(assign)  i := (i+1)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (c (Array Int Int)) ) ( => (assign_38_2_272 c  b  a  N  i ) (while_35_1_275 c  b  a  N  (+ i  1)))))
(check-sat)
