...
;
(set-logic HORN)
(declare-fun assert_95_1_522 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_92_2_509 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_91_2_500 (Int (Array Int Int) Int Int ) Bool)
(declare-fun while_89_1_512 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_88_1_479 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_85_2_470 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_84_2_461 (Int (Array Int Int) Int Int ) Bool)
(declare-fun while_82_1_473 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_81_1_440 (Int (Array Int Int) Int Int ) Bool)
...
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_75_1_434 sum  a  N  i ) (not (< i  N ))) (assign_81_1_440 sum  a  N  i ))))
;
;(assign)  sum := (sum-a[i])
...
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_81_1_440 sum  a  N  i ) (while_82_1_473 sum  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_82_1_473 sum  a  N  i ) (< i  N )) (assign_84_2_461 sum  a  N  i ))))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_82_1_473 sum  a  N  i ) (not (< i  N ))) (assign_88_1_479 sum  a  N  i ))))
;
;(assign)  sum := (sum-a[i])
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_84_2_461 sum  a  N  i ) (assign_85_2_470 (- sum  (select a  i )) a  N  i ))))
;
;(assign)  i := (i+1)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_85_2_470 sum  a  N  i ) (while_82_1_473 sum  a  N  (+ i  1)))))
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_88_1_479 sum  a  N  i ) (while_89_1_512 sum  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_89_1_512 sum  a  N  i ) (< i  N )) (assign_91_2_500 sum  a  N  i ))))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_89_1_512 sum  a  N  i ) (not (< i  N ))) (assert_95_1_522 sum  a  N  i ))))
;
;(assign)  sum := (sum-a[i])
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_91_2_500 sum  a  N  i ) (assign_92_2_509 (- sum  (select a  i )) a  N  i ))))
;
;(assign)  i := (i+1)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_92_2_509 sum  a  N  i ) (while_89_1_512 sum  a  N  (+ i  1)))))
;
;(assert)  (sum==0)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_95_1_522 sum  a  N  i ) (= sum  0))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_95_1_522 sum  a  N  i ) (end sum  a  N  i ))))
(check-sat)
