...
;
(set-logic HORN)
(declare-rel assert_81_1_444 (Int Int Int Int Int Int))
...
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_75_1_434 sum a_size a1_ind a1_val N i) (not (< i N))) (assert_81_1_444 sum a_size a1_ind a1_val N i))))
;
;(assign)  sum := (sum-a[i])
...
;
;(assert)  (sum==0)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_81_1_444 sum a_size a1_ind a1_val N i)) (= sum 0))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_81_1_444 sum a_size a1_ind a1_val N i)) (end sum a_size a1_ind a1_val N i))))
(check-sat)
