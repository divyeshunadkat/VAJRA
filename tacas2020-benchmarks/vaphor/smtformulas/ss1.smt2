...
;
(set-logic HORN)
(declare-fun assert_39_1_226 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_36_2_198 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assign_35_2_189 (Int (Array Int Int) Int Int ) Bool)
(declare-fun while_33_1_201 (Int (Array Int Int) Int Int ) Bool)
...
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_32_1_168 sum  a  N  i ) (while_33_1_201 sum  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_33_1_201 sum  a  N  i ) (< i  N )) (assign_35_2_189 sum  a  N  i ))))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_33_1_201 sum  a  N  i ) (not (< i  N ))) (assert_39_1_226 sum  a  N  i ))))
;
;(assign)  sum := (sum+a[i])
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_35_2_189 sum  a  N  i ) (assign_36_2_198 (+ sum  (select a  i )) a  N  i ))))
;
;(assign)  i := (i+1)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_36_2_198 sum  a  N  i ) (while_33_1_201 sum  a  N  (+ i  1)))))
;
;(assert)  ((N<=0)||(sum==(N*(N+2))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_39_1_226 sum  a  N  i ) (or (<= N  0) (= sum  (* N  (+ N  2)))))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_39_1_226 sum  a  N  i ) (end sum  a  N  i ))))
(check-sat)
