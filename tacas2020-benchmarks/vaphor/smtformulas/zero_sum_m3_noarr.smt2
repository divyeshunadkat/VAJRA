...
;
(set-logic HORN)
(declare-rel assert_53_1_288 (Int Int Int Int Int Int))
...
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_47_1_278 sum a_size a1_ind a1_val N i) (not (< i N))) (assert_53_1_288 sum a_size a1_ind a1_val N i))))
;
;(assign)  sum := (sum-a[i])
...
;
;(assert)  (sum==0)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_53_1_288 sum a_size a1_ind a1_val N i)) (= sum 0))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_53_1_288 sum a_size a1_ind a1_val N i)) (end sum a_size a1_ind a1_val N i))))
(check-sat)
