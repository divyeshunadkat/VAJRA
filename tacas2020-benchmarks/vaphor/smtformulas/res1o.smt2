...
(declare-fun arrayassign_29_2_150 (Int (Array Int Int) (Array Int Int) Int Int ) Bool)
...
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (sum Int) ) ( => (assign_26_1_132 sum  b  a  N  i ) (while_27_1_162 sum  b  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((sum Int) (b (Array Int Int)) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_27_1_162 sum  b  a  N  i ) (< i  N )) (arrayassign_29_2_150 sum  b  a  N  i ))))
...
;
;(aassign) b[i] := 1
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (b (Array Int Int)) (sum Int) ) ( => (arrayassign_29_2_150 sum  b  a  N  i ) (assign_30_2_159 sum  (store b  i  1) a  N  i ))))
;
;(assign)  i := (i+1)
