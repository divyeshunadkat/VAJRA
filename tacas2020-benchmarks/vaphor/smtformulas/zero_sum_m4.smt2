...
;
(set-logic HORN)
(declare-fun assert_67_1_366 (Int (Array Int Int) Int Int ) Bool)
...
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_61_1_356 sum  a  N  i ) (not (< i  N ))) (assert_67_1_366 sum  a  N  i ))))
;
;(assign)  sum := (sum-a[i])
...
;
;(assert)  (sum==0)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_67_1_366 sum  a  N  i ) (= sum  0))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_67_1_366 sum  a  N  i ) (end sum  a  N  i ))))
(check-sat)
