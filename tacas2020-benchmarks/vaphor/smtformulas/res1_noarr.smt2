...
(declare-rel arrayassign_22_2_111 (Int Int Int Int Int Int Int Int Int))
...
;
;(while)   while((i<N))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (while_20_1_123 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (< i N)) (arrayassign_22_2_111 sum b_size b1_ind b1_val a_size a1_ind a1_val N i))))
