...
(declare-rel while_19_8_115 (Int Int Int Int Int Int))
...
;
;(assign)  i := 0
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assign_18_1_85 sum a_size a1_ind a1_val N i)) (while_19_8_115 sum a_size a1_ind a1_val N 0))))
;
;(while)   while((i<N))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_19_8_115 sum a_size a1_ind a1_val N i) (< i N)) (arrayassign_21_2_103 sum a_size a1_ind a1_val N i))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_19_8_115 sum a_size a1_ind a1_val N i) (not (< i N))) (assign_25_1_121 sum a_size a1_ind a1_val N i))))
;
;(aassign) a[i] := sum
...
;
;(assign)  i := (i+1)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assign_22_2_112 sum a_size a1_ind a1_val N i)) (while_19_8_115 sum a_size a1_ind a1_val N (+ i 1)))))
;
;(assign)  i := 0
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assign_25_1_121 sum a_size a1_ind a1_val N i)) (while_26_8_158 sum a_size a1_ind a1_val N 0))))
;
;(while)   while((i<N))
