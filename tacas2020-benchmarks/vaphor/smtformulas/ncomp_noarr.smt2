...
;
(set-logic HORN)
(declare-rel assign_38_2_272 (Int Int Int Int Int Int Int Int Int Int Int))
(declare-rel assert_37_2_263 (Int Int Int Int Int Int Int Int Int Int Int))
(declare-rel while_35_1_275 (Int Int Int Int Int Int Int Int Int Int Int))
...
;
;(aassign) c[0] := N
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int) (tmp_store_c1_ind Int) (tmp_store_c1_val Int) (tmp_store_c_size Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (arrayassign_11_1_74 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i) (= tmp_store_c1_ind c1_ind) (= c_size tmp_store_c_size) (or (and (= c1_ind 0) (= tmp_store_c1_val N)) (and (not (= c1_ind 0)) (= tmp_store_c1_val c1_val)))) (assign_13_1_80 tmp_store_c_size tmp_store_c1_ind tmp_store_c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i))))
;
;(assign)  i := 1
...
;
;(assign)  i := 0
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (assign_34_1_232 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i)) (while_35_1_275 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N 0))))
;
;(while)   while((i<N))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (while_35_1_275 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i) (< i N)) (assert_37_2_263 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (while_35_1_275 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i) (not (< i N))) (end c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i))))
;
;(assert)  (c[i]==(N+((i*i)*i)))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int) (tmp_select_c Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (assert_37_2_263 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i) (or (and (= c1_ind i) (= tmp_select_c c1_val)) (and (< i c1_ind) (<= 0 c_size) (assert_37_2_263 c_size i tmp_select_c b_size b1_ind b1_val a_size a1_ind a1_val N i)) (and (< c1_ind i) (<= 0 c_size) (assert_37_2_263 c_size i tmp_select_c b_size b1_ind b1_val a_size a1_ind a1_val N i)))) (= tmp_select_c (+ N (* (* i i) i))))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (assert_37_2_263 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i)) (assign_38_2_272 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i))))
;
;(assign)  i := (i+1)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (c1_ind Int) (c1_val Int) (c_size Int) (i Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (<= 0 c_size) (assign_38_2_272 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N i)) (while_35_1_275 c_size c1_ind c1_val b_size b1_ind b1_val a_size a1_ind a1_val N (+ i 1)))))
(check-sat)
