...
;
(set-logic HORN)
(declare-fun assign_36_2_202 (Int (Array Int Int) Int Int ) Bool)
(declare-fun assert_35_2_193 (Int (Array Int Int) Int Int ) Bool)
(declare-fun while_33_1_205 (Int (Array Int Int) Int Int ) Bool)
...
;
;(assign)  i := 0
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_32_1_168 sum  a  N  i ) (while_33_1_205 sum  a  N  0))))
;
;(while)   while((i<N))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_33_1_205 sum  a  N  i ) (< i  N )) (assert_35_2_193 sum  a  N  i ))))
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_33_1_205 sum  a  N  i ) (not (< i  N ))) (end sum  a  N  i ))))
;
;(assert)  (a[i]==(N+1))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_35_2_193 sum  a  N  i ) (= (select a  i ) (+ N  1)))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_35_2_193 sum  a  N  i ) (assign_36_2_202 sum  a  N  i ))))
;
;(assign)  i := (i+1)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assign_36_2_202 sum  a  N  i ) (while_33_1_205 sum  a  N  (+ i  1)))))
(check-sat)
