...
;
(set-logic HORN)
(declare-rel assert_40_1_232 (Int Int Int Int Int Int))
...
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (while_34_1_207 sum a_size a1_ind a1_val N i) (not (< i N))) (assert_40_1_232 sum a_size a1_ind a1_val N i))))
;
;(assign)  sum := (sum+a[i])
...
;
;(assert)  ((N<=0)||(sum==(N*(N+1))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_40_1_232 sum a_size a1_ind a1_val N i)) (or (<= N 0) (= sum (* N (+ N 1)))))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (assert_40_1_232 sum a_size a1_ind a1_val N i)) (end sum a_size a1_ind a1_val N i))))
(check-sat)
