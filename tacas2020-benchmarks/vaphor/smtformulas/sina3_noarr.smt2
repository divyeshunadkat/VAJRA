...
;
(set-logic HORN)
(declare-rel assign_44_2_245 (Int Int Int Int Int Int Int Int Int))
(declare-rel assert_43_2_236 (Int Int Int Int Int Int Int Int Int))
(declare-rel while_41_1_248 (Int Int Int Int Int Int Int Int Int))
(declare-rel assign_40_1_211 (Int Int Int Int Int Int Int Int Int))
(declare-rel assign_37_2_202 (Int Int Int Int Int Int Int Int Int))
(declare-rel arrayassign_36_2_193 (Int Int Int Int Int Int Int Int Int))
(declare-rel while_34_1_205 (Int Int Int Int Int Int Int Int Int))
...
;
;(assign)  i := 0
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (assign_33_1_168 sum b_size b1_ind b1_val a_size a1_ind a1_val N i)) (while_34_1_205 sum b_size b1_ind b1_val a_size a1_ind a1_val N 0))))
;
;(while)   while((i<N))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (while_34_1_205 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (< i N)) (arrayassign_36_2_193 sum b_size b1_ind b1_val a_size a1_ind a1_val N i))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (while_34_1_205 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (not (< i N))) (assign_40_1_211 sum b_size b1_ind b1_val a_size a1_ind a1_val N i))))
;
;(aassign) a[i] := (b[i]+sum)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int) (tmp_select_b Int) (tmp_store_a1_ind Int) (tmp_store_a1_val Int) (tmp_store_a_size Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (arrayassign_36_2_193 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (or (and (= b1_ind i) (= tmp_select_b b1_val)) (and (< i b1_ind) (<= 0 b_size) (arrayassign_36_2_193 sum b_size i tmp_select_b a_size a1_ind a1_val N i)) (and (< b1_ind i) (<= 0 b_size) (arrayassign_36_2_193 sum b_size i tmp_select_b a_size a1_ind a1_val N i))) (= tmp_store_a1_ind a1_ind) (= a_size tmp_store_a_size) (or (and (= a1_ind i) (= tmp_store_a1_val (+ tmp_select_b sum))) (and (not (= a1_ind i)) (= tmp_store_a1_val a1_val)))) (assign_37_2_202 sum b_size b1_ind b1_val tmp_store_a_size tmp_store_a1_ind tmp_store_a1_val N i))))
;
;(assign)  i := (i+1)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (assign_37_2_202 sum b_size b1_ind b1_val a_size a1_ind a1_val N i)) (while_34_1_205 sum b_size b1_ind b1_val a_size a1_ind a1_val N (+ i 1)))))
;
;(assign)  i := 0
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (assign_40_1_211 sum b_size b1_ind b1_val a_size a1_ind a1_val N i)) (while_41_1_248 sum b_size b1_ind b1_val a_size a1_ind a1_val N 0))))
;
;(while)   while((i<N))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (while_41_1_248 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (< i N)) (assert_43_2_236 sum b_size b1_ind b1_val a_size a1_ind a1_val N i))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (while_41_1_248 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (not (< i N))) (end sum b_size b1_ind b1_val a_size a1_ind a1_val N i))))
;
;(assert)  (a[i]==(N+1))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int) (tmp_select_a Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (assert_43_2_236 sum b_size b1_ind b1_val a_size a1_ind a1_val N i) (or (and (= a1_ind i) (= tmp_select_a a1_val)) (and (< i a1_ind) (<= 0 a_size) (assert_43_2_236 sum b_size b1_ind b1_val a_size i tmp_select_a N i)) (and (< a1_ind i) (<= 0 a_size) (assert_43_2_236 sum b_size b1_ind b1_val a_size i tmp_select_a N i)))) (= tmp_select_a (+ N 1)))))
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (assert_43_2_236 sum b_size b1_ind b1_val a_size a1_ind a1_val N i)) (assign_44_2_245 sum b_size b1_ind b1_val a_size a1_ind a1_val N i))))
;
;(assign)  i := (i+1)
(assert (forall ((N Int) (a1_ind Int) (a1_val Int) (a_size Int) (b1_ind Int) (b1_val Int) (b_size Int) (i Int) (sum Int)) (=> (and (<= 0 a_size) (<= 0 b_size) (assign_44_2_245 sum b_size b1_ind b1_val a_size a1_ind a1_val N i)) (while_41_1_248 sum b_size b1_ind b1_val a_size a1_ind a1_val N (+ i 1)))))
(check-sat)
