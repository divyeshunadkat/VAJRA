...
;
(set-logic HORN)
(declare-fun assert_38_1_210 (Int (Array Int Int) Int Int ) Bool)
...
(assert (forall ((sum Int) (a (Array Int Int)) (N Int) (i Int) ) ( => ( and (while_33_1_200 sum  a  N  i ) (not (< i  N ))) (assert_38_1_210 sum  a  N  i ))))
;
;(assign)  sum := (sum-a[i])
...
;
;(assert)  (sum==0)
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_38_1_210 sum  a  N  i ) (= sum  0))))
(assert (forall ((i Int) (N Int) (a (Array Int Int)) (sum Int) ) ( => (assert_38_1_210 sum  a  N  i ) (end sum  a  N  i ))))
(check-sat)
